<?php
	...
	try
	{
        ...
        $sql_insert_visitor = "INSERT INTO visits(ip_address,device,browser,city) 
                                VALUES ('$user_ip_address','$device_type','$browser_name','$city')";
        ...
        /*$result_insert_visitor = mysqli_query($con, $sql_insert_visitor);
    ...
    {
        echo "Error Occured While Retriving Data";
    }
?>